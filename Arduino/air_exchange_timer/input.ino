...
#define INPUT_X_BITS 0x0003
#define INPUT_X_IS_ON_PATTERN 0x0003
#define INPUT_X_SWITCHED_ON_PATTERN 0x0001
#define INPUT_X_SWITCHED_OFF_PATTERN 0x0002


/* Element specific  button bit pattern */
/*                                         76543210 */

#define INPUT_BUTTON_0_BITS              0x0003
#define INPUT_BUTTON_0_IS_PRESSED_PATTERN   0x0003
#define INPUT_BUTTON_0_GOT_PRESSED_PATTERN   0x0001
#define INPUT_BUTTON_0_GOT_RELEASED_PATTERN  0x0002


#define INPUT_BUTTON_1_BITS                  0x000c
#define INPUT_BUTTON_1_IS_PRESSED_BIT        0x0004
#define INPUT_BUTTON_1_GOT_PRESSED_PATTERN   0x0004
#define INPUT_BUTTON_1_GOT_RELEASED_PATTERN  0x0008
...
bool input_button_0_GotPressed()
{

  return input_enabled && ((button_tick_state & INPUT_BUTTON_0_BITS) == INPUT_BUTTON_0_GOT_PRESSED_PATTERN);
}

bool input_button_0_IsPressed()
{
  return input_enabled && ((button_tick_state & INPUT_BUTTON_0_BITS) == INPUT_BUTTON_0_IS_PRESSED_PATTERN); 
}

byte input_button_0_GotReleased()
{
  return input_enabled && ((button_tick_state & INPUT_BUTTON_0_BITS) == INPUT_BUTTON_0_GOT_RELEASED_PATTERN); 
}

bool input_button_1_GotPressed()
{

  return input_enabled && ((button_tick_state & INPUT_BUTTON_1_BITS) == INPUT_BUTTON_1_GOT_PRESSED_PATTERN);
}

bool input_button_1_IsPressed()
{
  return input_enabled && (button_tick_state & INPUT_BUTTON_1_IS_PRESSED_BIT ); 
}

byte input_button_1_GotReleased()
{
  return input_enabled && ((button_tick_state & INPUT_BUTTON_1_BITS) == INPUT_BUTTON_1_GOT_RELEASED_PATTERN); 
}
...
void input_switches_scan_tick()
{
  ...
  {
    if((button_tick_state & (INPUT_X_BITS<<(i*2))) == INPUT_X_SWITCHED_ON_PATTERN<<(i*2)) 
    {
    ...
    if((button_tick_state & (INPUT_X_BITS<<(i*2))) == INPUT_X_SWITCHED_OFF_PATTERN<<(i*2)) 
    {
